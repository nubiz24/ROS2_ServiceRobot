...
#include "kaiaai_msgs/msg/detail/wifi_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const kaiaai_msgs::msg::WifiState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  kaiaai_msgs::msg::WifiState & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kaiaai_msgs::msg::WifiState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kaiaai_msgs::msg::WifiState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kaiaai_msgs::msg::WifiState *>(
    untyped_ros_message);
...
{
  return &kaiaai_msgs::msg::typesupport_fastrtps_cpp::_WifiState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kaiaai_msgs, msg, WifiState)() {
  return &kaiaai_msgs::msg::typesupport_fastrtps_cpp::_WifiState__handle;
}
