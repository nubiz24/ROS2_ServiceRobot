...
#include "kaiaai_msgs/msg/detail/wifi_state__rosidl_typesupport_fastrtps_c.h"
...
using _WifiState__ros_msg_type = kaiaai_msgs__msg__WifiState;
...
static uint32_t _WifiState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_kaiaai_msgs__msg__WifiState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kaiaai_msgs__msg__WifiState;
    is_plain =
      (
...
static size_t _WifiState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_kaiaai_msgs__msg__WifiState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kaiaai_msgs, msg, WifiState)() {
