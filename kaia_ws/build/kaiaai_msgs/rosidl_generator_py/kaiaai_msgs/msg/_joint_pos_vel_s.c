...
bool kaiaai_msgs__msg__joint_pos_vel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kaiaai_msgs.msg._joint_pos_vel.JointPosVel", full_classname_dest, 42) == 0);
  }
  kaiaai_msgs__msg__JointPosVel * ros_message = _ros_message;
  {  // pos
...
{
  /* NOTE(esteve): Call constructor of JointPosVel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kaiaai_msgs.msg._joint_pos_vel");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointPosVel");
