...
static const _WifiState_type_support_symbol_names_t _WifiState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kaiaai_msgs, msg, WifiState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kaiaai_msgs, msg, WifiState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kaiaai_msgs, msg, WifiState)() {
  return &::kaiaai_msgs::msg::rosidl_typesupport_c::WifiState_message_type_support_handle;
}
