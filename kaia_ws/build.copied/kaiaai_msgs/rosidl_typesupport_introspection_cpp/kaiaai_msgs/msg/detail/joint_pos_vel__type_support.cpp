...
{
  new (message_memory) kaiaai_msgs::msg::JointPosVel(_init);
}

void JointPosVel_fini_function(void * message_memory)
{
  auto typed_message = static_cast<kaiaai_msgs::msg::JointPosVel *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointPosVel_message_member_array[2] = {
  {
    ...
    offsetof(kaiaai_msgs::msg::JointPosVel, pos),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(kaiaai_msgs::msg::JointPosVel, vel),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointPosVel_message_members = {
  ...
  2,  // number of fields
  sizeof(kaiaai_msgs::msg::JointPosVel),
...
{
  return &::kaiaai_msgs::msg::rosidl_typesupport_introspection_cpp::JointPosVel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kaiaai_msgs, msg, JointPosVel)() {
  return &::kaiaai_msgs::msg::rosidl_typesupport_introspection_cpp::JointPosVel_message_type_support_handle;
}
