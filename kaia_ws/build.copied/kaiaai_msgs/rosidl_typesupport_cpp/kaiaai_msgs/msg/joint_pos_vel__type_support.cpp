...
static const _JointPosVel_type_support_symbol_names_t _JointPosVel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kaiaai_msgs, msg, JointPosVel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kaiaai_msgs, msg, JointPosVel)),
  }
};
...
{
  return &::kaiaai_msgs::msg::rosidl_typesupport_cpp::JointPosVel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, kaiaai_msgs, msg, JointPosVel)() {
  return get_message_type_support_handle<kaiaai_msgs::msg::JointPosVel>();
}
