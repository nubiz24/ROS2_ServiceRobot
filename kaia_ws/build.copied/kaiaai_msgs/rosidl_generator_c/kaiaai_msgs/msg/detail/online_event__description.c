  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x22, 0x8d, 0x00, 0xf3, 0xfe, 0x53, 0x7f, 0x68,
      0x18, 0x6a, 0xb1, 0x23, 0x0b, 0xe7, 0x84, 0x43,
      0xae, 0x20, 0x79, 0xb6, 0x81, 0x4b, 0x05, 0x06,
      0x57, 0xb9, 0x10, 0x7d, 0xa5, 0xce, 0xb9, 0x9d,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t diagnostic_msgs__msg__DiagnosticArray__EXPECTED_HASH = {1, {
...
static char kaiaai_msgs__msg__OnlineEvent__TYPE_NAME[] = "kaiaai_msgs/msg/OnlineEvent";
...
static char kaiaai_msgs__msg__OnlineEvent__FIELD_NAME__event[] = "event";
static char kaiaai_msgs__msg__OnlineEvent__FIELD_NAME__comment[] = "comment";
static char kaiaai_msgs__msg__OnlineEvent__FIELD_NAME__diag[] = "diag";

static rosidl_runtime_c__type_description__Field kaiaai_msgs__msg__OnlineEvent__FIELDS[] = {
  {
    {kaiaai_msgs__msg__OnlineEvent__FIELD_NAME__event, 5, 5},
    {
  ...
  {
    {kaiaai_msgs__msg__OnlineEvent__FIELD_NAME__comment, 7, 7},
    {
  ...
  {
    {kaiaai_msgs__msg__OnlineEvent__FIELD_NAME__diag, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription kaiaai_msgs__msg__OnlineEvent__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {kaiaai_msgs__msg__OnlineEvent__TYPE_NAME, 27, 27},
      {kaiaai_msgs__msg__OnlineEvent__FIELDS, 3, 3},
    },
    {kaiaai_msgs__msg__OnlineEvent__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
    assert(0 == memcmp(&builtin_interfaces__msg__Time__EXPECTED_HASH, builtin_interfaces__msg__Time__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = builtin_interfaces__msg__Time__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&diagnostic_msgs__msg__DiagnosticArray__EXPECTED_HASH, diagnostic_msgs__msg__DiagnosticArray__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[1].fields = diagnostic_msgs__msg__DiagnosticArray__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[2].fields = diagnostic_msgs__msg__DiagnosticStatus__get_type_description(NULL)->type_description.fields;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *kaiaai_msgs__msg__OnlineEvent__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *diagnostic_msgs__msg__DiagnosticArray__get_individual_type_description_source(NULL);
    sources[3] = *diagnostic_msgs__msg__DiagnosticStatus__get_individual_type_description_source(NULL);
